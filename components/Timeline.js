...
let entries = {
    ...
    content: (
      <>
        <p>
          ...
          tomorrow! I won't be able to stay at <a href="">Hack Club HQ</a> the
          whole way through but I'm still super excited to meet the awesome
    ...
    content: (
      <>
        <p>
          ...
          - Al's French Fries! - and then met my new roommates, who it turns out
          had invited a bunch of people over! Seven people in total. We made
          burgers, curly fries, and salad together, talked a bit, and watched{' '}
          <a href="">Missing</a> together. Holy crap, I was either laughing so
          hard or trying hard not to look at the screen. I'm honestly nervous
          when it comes to new people, but it was so much fun! Tomorrow we'll be
          going to a renaissance fair, which I've never been to before. We'll
          see how it goes; someone bought a $70 cowboy hat for the occasion!
          Anyways, writing this and finishing up my BWSI courses right now. It's
          close to 12AM!
        </p>
        <p>
          Oh, I forgot to mention what I did on the bus. Well, first of all,
          Albany's Union Station stinks. Would not recommend, -infinity/10. I
          wanted to puke so bad, but it smelled like weed outside and was humid,
          so I had no choice but to stay inside. That being said, the WiFi also
          sucked, so I did a lot of work on Marrow and also started reading{' '}
    ...
    content: (
      <>
        <p>
          ...
          <a href="">Skinny Pancakes</a>, but I didn't eat anything because
          right afterwards we headed over to <a href="">Woody Keppel</a>
          's house for a potluck dinner and to watch a band,{' '}
          <a href="">Mal Maiz</a>, play music. Literally so fun! The food people
          bought was so good, and even though it started raining halfway, the
          show was still super enjoyable (did I forget to mention that there was
          a plate spinning introduction?) and we played some Man in the Middle
          with a football while dancing to the music in the rain, which was
          honestly so fun.
        </p>
        <p>
          Coming home, some interesting music was played in the car, so they're
          both going in my playlist: <a href="">Runaway (U &amp; I)</a> and{' '}
          <a href="">Live in the Moment</a>. The latter has these two verses:
        </p>
        <blockquote>
  ...
  '06/26': {
    content: (
      <p>
        ...
        <a href="">Steve</a>. We then decided to head over to HQ to sleep there
        for the night, which meant curling up on the couch together and watching{' '}
        <a href="">Mamma Mia</a>. I actually promptly fell asleep a solid
        fifteen minutes after the movie started, so I didn't watch it. The music
        is good to sleep too. The couch was so fucking tight that my back hurts
        so much, but it was also really cozy and I felt like I actually
        belonged. Like someone put their head on my shoulder, I kept kicking
        someone in the shins, and somebody was sleeptalking. You know, the
        awkward but sweet kind of close. There was six of us on one couch! How
    ...
    content: (
      <>
        ...
        <p>
          ...
          lunch, we invited <a href="">Jeffrey Hollender</a>, who founded one of
          the first sustainable cleaning solution companies, to come have a
          little picnic chat with us. His son, who actually led Wikipedia's
          redesign project, also came and talked about that a bit!
        </p>
        <p>
          Also had my first team sync today, followed by Ben &amp; Jerry's ice
          cream right after. <a href="">Conrad Kramer</a> is here! Honestly
          adults are so intimidating but I really liked listening to his
          conversations with other people even though I really don't know much
          about Rust, etc. I need to add that to my summer bucket list.
        </p>
        <p>
  ...
  '06/28': {
    content: (
      <p>
        Mostly another day of work! Afterwards we went to an Irish pub in the
        middle of Burlington. People may or may not have bought alcohol with a
        fake ID. Then we went to the Vermont Comedy Club for Wednesday Open Mic
        night. Some of the sets were hilarious, but by the end of the night, I
        had enough of penis jokes. Pretty fun though! I've been feeling like an
        adult, but I specifically felt like an adult tonight. I mean, I was in a
        pub! I mean, it's not like I drank anything but still...
      </p>
    )
  },
  '06/29': {
  ...
  '06/30': {
    content: (
      <p>
        ...
        zucchini with a sword that <a href="">Claire</a> got from Amazon for{' '}
        <a href="">AngelHacks</a>! <a href="">Thomas</a> happened to bring it to
        HQ.
      </p>
    )
  },
  '07/01': {
    content: (
      <p>
        ...
        bookstore that <a href="">Belle</a> recommended (except I couldn't find
        any books that I could, you know, afford and that I also found
        interesting). Afterwards bought some canned pineapples and had a dinner
        with some people and watched the latest season of{' '}
        <a href="">Love Island: UK</a>. Never watched it before, but now we're
        going to Love Island: Hack Club (not related to romance in case you were
        wondering, but more like: "My hobby is centering <code>div</code>s" kind
        of thing), which I can't decide is concerning or amusing.
      </p>
    )
  },
  '07/02': {
    content: (
      <p>
        ...
        <a href="">Someone Else's Problem</a>.
      </p>
    )
  },
  '07/03': {
    content: (
      <>
        <p>
          ...
          went to <a href="">Lake Champlain</a> to watch Burlington's{' '}
          <a href="">annual fireworks show</a>. Even though I have like fifteen
          billion mosquito bites, it was so worth it because the food was good,
          the sunset was great, the concert was great, and the drone show
          followed by fireworks right after was fucking amazing.
        </p>
        <p>
          ...
          like I was at home for the first time in my life. Theis thought is
  ...
  '07/04': {
    content: (
      <p>
        ...
        Black Mirror (the one with the meme face), and then <em>Mean Girls</em>.
  ...
  '07/05': {
    content: (
      <p>
        ...
        just went home after work, ate some leftovers, watched Black Mirror: San
        Junipero (that's the queer one, and it's so good and bittersweet because
        you know they don't exist physically but they're still kind of living
        their lives out in their death???), wrote for a while, and then clunked
        out straight to sleep.
      </p>
    )
  },
  '07/06': {
    content: (
      <>
        <p>
          ...
          <a href="">Pokegotchi</a> (yes we now have a name!). Going to buy some
          groceries at the supermarket so we can run the hackathon tomorrow. My
          last day is going to be so busy and hopefully a sad :( goodbye party
          of sorts. On the list of things that are going to happen tomorrow are:
        </p>
        <ul>
    ...
    content: (
      <>
        ...
        <p>
          ...
          ice cream at the <a href="">Microcreamery</a> (I really should have
          taken pictures) and then came home, then walked a mile to buy
          groceries from Target, then found out promptly that there was a Dollar
          Tree and Chinese supermarket closer to us while walking the mile back
          with a seven-pound grocery bag. Fun!
        </p>
        <p>
    ...
    content: (
      <>
        ...
        <p>
          ...
          asleep during Jane Abbott's lecture, but I got away. Also got lost
          around MIT around 15 times, so doing super great. Also lots of merch.
          That's it.
        </p>
      </>
    )
    ...
    content: (
      <>
        ...
        <p>
          ...
          <em>The Hunt for Red October</em> because apparently it's a bigger
          scale version of the challenge we'll be doing at the end of the
          program.
        </p>
        <p>
  ...
  '07/12': {
    content: (
      <>
        <p>
          Sitting in Boston Public Library - Central right now! Holy heck it's
          so big. I borrowed three of the books on my summer reading list:{' '}
          <em>The Ray Tracer Challenge</em> (yes it's time to update that post),{' '}
        ...
        <p>
          Basically, I'll try to explain it here so I remember. Let's take a ROV
          in the water, it has the pressure of gravity (an acceleration that
          we'll also consider to be a force). The water also creates buoyancy,
          so we'll consider it to be pushing up while gravity is pushing down.
          (Technically, you could do it the other way too.) The formula for
          buoyancy is called Archimedes' principle and it's basically:
        </p>
        <img
          alt=""
          src="https://www.gstatic.com/education/formulas2/472522532/en/archimedes_principle.svg"
        />
      </>
    )
  }
